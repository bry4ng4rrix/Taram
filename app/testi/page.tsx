  ...
  return (
    <div className="min-h-screen w-full bg-stone-950 flex flex-col items-center mt-10  p-4 border-b border-[#6FE0B3]/30">
        <div className="flex flex-col justify-center items-center gap-4">
           ...
           <div>
            <h1 className="text-white text-4xl font-bold">Mais <span className="text-6xl text-[#6FE0B3]">où</span> est la 
            <span className="text-6xl text-[#6FE0B3]"> différence</span> ?</h1>
